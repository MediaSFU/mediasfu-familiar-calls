...
android {
    namespace = "com.mediasfu.familiarcall"
    compileSdk = 35

    defaultConfig {
        applicationId = "com.mediasfu.familiarcall"
        minSdk = 26
        targetSdk = 35
        versionCode = 1
        versionName = "0.1.0"

        val backend = providers.gradleProperty("callBackendBaseUrl")
            .orElse("http://10.0.2.2:8790")
            .get()
